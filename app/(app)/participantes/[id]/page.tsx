        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {casos.map((c) => (
            ...
            >
              ...
              <span
                className={`shrink-0 ml-3 rounded-full px-2.5 py-1 text-[11px] font-medium border ${
          ...
          {casos.length === 0 && <p className="text-sm text-[var(--ink-muted)] sm:col-span-2">Nenhum caso clínico cadastrado ainda.</p>}
        </div>
      </div>

/** Catálogo de skills/ferramentas MCP disponíveis para agentes (Módulo 7). */
export const TOOLS_META = [
  { id: "vtex.pedidos", label: "VTEX · Pedidos", desc: "Consulta pedidos, faturamento e clientes (Orders API, leitura)" },
  { id: "vtex.produtos", label: "VTEX · Produtos", desc: "Consulta catálogo de produtos e preços (Catalog API)" },
